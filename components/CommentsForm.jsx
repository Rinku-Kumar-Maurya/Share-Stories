...
const CommentsForm = ({ slug }) => {
    ...
    const handleCommentSubmission = () => {
        ...
        const { checked: saveData } = storeDataEl.current;
        ...
        <div className='bg-white shadow-lg rounded-lg pb-12 p-8 mb-8'>
            ...
            <div className='mt-8'>
                <button
                    ...
                    className='transition duration-500 ease-out hover:bg-indigo-900 inline-block bg-purple-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer'>
                    Post
                </button>
