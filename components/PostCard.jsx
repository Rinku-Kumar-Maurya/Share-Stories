    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            ...
            <div className='text-center'>
                <Link href={`/post/${post.slug}`}>
                    <span className='transation duration-500 transform hover:-translate-y-1 inline-block text-lg font-medium rounded-full text-white py-3 px-8 cursor-pointer bg-purple-700'>Continue Reading</span>
                </Link>
            </div>
        </div>
    )
